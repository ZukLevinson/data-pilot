...
import { ProductsService } from '@org/portal/data';
import { Product } from '@org/models';
import { LoadingSpinnerComponent, ErrorMessageComponent } from '@org/portal/shared-ui';

@Component({
  selector: 'portal-product-detail',
  imports: [
    CommonModule,
    CurrencyPipe,
    RouterLink,
